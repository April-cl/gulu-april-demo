...
exports.default = _default;
        var $9577cd = exports.default || module.exports;
      
      if (typeof $9577cd === 'function') {
        $9577cd = $9577cd.options;
      }
    
        /* template */
        Object.assign($9577cd, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9577cd', $9577cd);
          } else {
            api.reload('$9577cd', $9577cd);
          }
        }
